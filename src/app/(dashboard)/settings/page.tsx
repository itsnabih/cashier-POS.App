  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-slate-200 pb-4 flex justify-between items-center">
        ...
        <button type="button" className="px-3 py-1.5 bg-baby-50 text-baby-700 text-sm font-medium rounded-md hover:bg-baby-100">
          + Tambah Pengguna
        </button>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left">
          ...
          <tbody className="divide-y divide-slate-100">
            <tr>
              <td className="px-4 py-3 font-medium text-slate-800">Owner System</td>
              <td className="px-4 py-3 text-slate-600">owner</td>
              <td className="px-4 py-3"><span className="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded-full">Owner</span></td>
              <td className="px-4 py-3"><span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">Aktif</span></td>
              <td className="px-4 py-3 text-right">
                 <button className="text-baby-600 hover:text-baby-900 text-xs font-medium">Edit</button>
              </td>
            </tr>
            <tr>
              <td className="px-4 py-3 font-medium text-slate-800">Admin Utama</td>
              <td className="px-4 py-3 text-slate-600">admin</td>
              <td className="px-4 py-3"><span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">Admin</span></td>
              <td className="px-4 py-3"><span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">Aktif</span></td>
              <td className="px-4 py-3 text-right">
                 <button className="text-baby-600 hover:text-baby-900 text-xs font-medium">Edit</button>
              </td>
            ...
            <tr>
              <td className="px-4 py-3 font-medium text-slate-800">Kasir 1</td>
              <td className="px-4 py-3 text-slate-600">kasir</td>
              <td className="px-4 py-3"><span className="px-2 py-1 bg-slate-100 text-slate-700 text-xs rounded-full">Kasir</span></td>
              <td className="px-4 py-3"><span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">Aktif</span></td>
              <td className="px-4 py-3 text-right">
                 <button className="text-baby-600 hover:text-baby-900 text-xs font-medium">Edit</button>
              </td>
